...
public record BarrierPayload(UUID ownerUuid, Vec3d position, Vec3d direction, int maxTicks, Identifier texture, float radius) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, BarrierPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.FLOAT, BarrierPayload::radius,
            BarrierPayload::new
    );
